...
| # | Block | Contents |
|---|---|---|
| 1 | Header | Title (pack or override), number or draft marker, issue date, due date or validity date, a quote's version |
...
four documents: a three-line invoice; a twenty-four-line invoice with two tax
codes, discounts and service periods, which must break across pages; a quote;
and a tax-inclusive B2C sale for `receipt`. No real company, person, address or
